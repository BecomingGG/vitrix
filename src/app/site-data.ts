...
export const FOOTER_NAV: NavItem[] = NAV.filter((item) => item.path !== '/partners');
...
export const PILLARS: Pillar[] = [
  {
    ...
    lines: ['Latest guidelines.', 'Real practice.'],
  },
  {
    title: 'Hands on',
    lines: ['High-fidelity', 'simulation.'],
  },
  {
    title: 'Expert faculty',
    lines: ['Clinicians.', 'Educators.', 'Mentors.'],
  },
  {
    title: 'Measurable impact',
    lines: ['Skills. Confidence.', 'Better outcomes.'],
  },
];
...
export const FACULTY = [
  {
    ...
    text: 'Faculty who still work the floor. They teach the decisions that show up on a night shift, not a slide that never survived contact with a patient.',
  },
  {
    role: 'Trauma surgeons',
    text: 'Surgeons who train the sequence before the operating room: what to see first, what to do now, and how to hand a patient over without losing the thread.',
  },
  {
    role: 'Critical care nurses',
    text: 'Nurses who run the bedside. They coach monitoring, escalation, and the teamwork that keeps a deteriorating patient from becoming a surprise.',
  },
  {
    role: 'Simulation educators',
    text: 'Specialists who design scenarios, run the room, and lead debriefs. Their job is to turn a single case into a skill the team can repeat.',
  },
];
...
export const PARTNERS = [
  {
    title: 'Hospitals',
    text: 'Emergency departments and critical care units that want teams trained against the cases they actually see.',
  },
  {
    title: 'EMS agencies',
    text: 'Prehospital services preparing crews for trauma, resuscitation, and the handover into the hospital.',
  },
  {
    title: 'Universities',
    text: 'Medical and nursing programs that need simulation tied to real clinical standards.',
  },
  {
    title: 'Simulation centers',
    text: 'Labs that want faculty, scenarios, and a shared language for human performance.',
  },
];
